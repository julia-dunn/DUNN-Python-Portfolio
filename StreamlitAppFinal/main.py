...
st.markdown("For example data to demonstrate the functions of this platform, download the CV titled ['Data for Calculating 'g''](https://github.com/julia-dunn/DUNN-Python-Portfolio/blob/31d41ae4c1cddf5faf96f05ba9d5c90c25eb9a9a/StreamlitAppFinal/Data%20for%20Calculating%20'g'%20-%20Sheet1.csv)from the github portforlio.")
