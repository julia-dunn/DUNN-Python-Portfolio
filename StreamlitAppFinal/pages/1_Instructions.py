...
with st.columns(3)[1]:
    st.image("https://i.postimg.cc/t77mqYf0/screenshot-freefall.png") # returns image in streamlit platform
...
with st.columns(3)[1]:
    st.image("https://i.postimg.cc/9w4xJnTX/screenshot-atwoodmachine.png") # returns image in streamlit platform
...
with st.columns(3)[1]:
    st.image("https://i.postimg.cc/Sj51JmFn/screenshot-incline.png") # returns image in streamlit platform
