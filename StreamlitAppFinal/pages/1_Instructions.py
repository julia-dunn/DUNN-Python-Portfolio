...
st.latex(r''' # uses latex syntax to return correctly formatted expression into streamlit app
        g = \frac{4\pi^2 L}{T^2}
        ''')
...
st.latex(r''' # uses latex syntax to return currectly formatted expression into streamlit app
