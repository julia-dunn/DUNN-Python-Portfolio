...
with st.columns(3)[1]:
    st.image("assets/screenshot_freefall.png") # returns image in streamlit platform
...
with st.columns(3)[1]:
    st.image("assets/screenshot_atwoodmachine.png") # returns image in streamlit platform
...
with st.columns(3)[1]:
    st.image("assets/screenshot_incline.png") # returns image in streamlit platform
