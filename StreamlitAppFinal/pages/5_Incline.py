...
for i in range(n):
    ...
    st.number_input(f"Height of track", value=None, placeholder="(meters)", key=f"Ih_{i}")
    st.number_input(f"Distance traveled along track", value=None, placeholder="(meters)", key=f"x_{i}")
    c1, c2, c3, c4, c5 = st.columns(5)
    c1.number_input(f"Trial 1", value=None, placeholder="time(s)", key=f"It1_{i}")
    c2.number_input(f"Trial 2", value=None, placeholder="time(s)", key=f"It2_{i}")
    c3.number_input(f"Trial 3", value=None, placeholder="time(s)", key=f"It3_{i}")
    c4.number_input(f"Trial 4", value=None, placeholder="time(s)", key=f"It4_{i}")
    c5.number_input(f"Trial 5", value=None, placeholder="time(s)", key=f"It5_{i}")